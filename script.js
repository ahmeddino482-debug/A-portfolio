...
<p>If you are looking for a data scientist with real expertise in space technologies, capable of turning space data into tangible value, I am ready to collaborate.</p>`
  ...
  ar: {
    navAbout:"من أنا", navSkills:"المهارات", navProjects:"المشاريع", navContact:"تواصل معي",
    ...
    aboutTitle:"من أنا",
    skillsTitle:"مهاراتي",
    skillAI:"الذكاء الاصطناعي وتعلم الآلة",
    skillAutomation:"الأتمتة",
    skillWeb:"تطوير الويب",
    skillSpace:"تقنيات الفضاء وبيانات الأقمار الصناعية",
